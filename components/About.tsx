        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 leading-tight mb-6">
              Bukan sekadar klub radio.<br />
              <span className="text-red-600">Lab eksperimen</span> pemuda.
            </h2>
            <p className="text-gray-600 leading-relaxed mb-6 text-lg">
              YOTA (Youngsters On The Air) adalah program internasional di bawah
              IARU yang menghubungkan anak muda pecinta teknologi dari seluruh
              dunia melalui radio amatir. Di Indonesia, YOTA dijalankan oleh ORARI
              sebagai wadah resmi pembinaan generasi muda.
            </p>
            <p className="text-gray-600 leading-relaxed mb-10">
              Kami percaya bahwa antena bukan sekadar kabel dan logam — ia adalah
              jembatan antara penasaran dan penemuan. Di YOTA, kamu bereksperimen
              dengan satelit sungguhan, membangun sensor kebencanaan dari nol, dan
              berbicara langsung dengan operator radio dari 150 negara.
            </p>
            ...
            <div className="flex flex-wrap gap-2">
              {["S.T.E.M", "Radio Amatir", "IoT Terapan", "Satelit", "ARDF", "Morse Code"].map((tag) => (
                <span
                  key={tag}
                  className="font-mono text-xs bg-gray-100 text-gray-700 border border-gray-200 px-3 py-1.5 rounded-full"
                >
                  {tag}
                </span>
              ))}
